...
(function () {
  ...
  const defaultLayout = {
    ...
    'added-plant-opening-babys-breath-right-mrobnbvu-2': { added: true, catalogId: 'plant-opening-babys-breath-right', sectionId: 'numbers', left: 1120, top: 577.17578125, width: 168, x: 360.55859375, y: -105.2734375, angle: 45, scale: 0.8, flip: -1, coordinateSpace: 'viewport', deleted: true, phone: { deleted: true } },
