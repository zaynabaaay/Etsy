...
(function () {
  ...
  const defaultLayout = {
    ...
    'dried-bundle': { left: 1601.46875, top: 82.83984375, width: 205, x: -7.9454345703125, y: 1011.3678283691406, angle: 44, scale: 0.73, flip: 1, sectionId: 'beginning', coordinateSpace: 'section', phone: { deleted: true }, deleted: true },
    ...
    'added-plant-generated-botanical-1-mrobmf54-1': { added: true, catalogId: 'plant-generated-botanical-1', sectionId: 'beginning', left: 1120, top: 1380, width: 175, x: -450.86328125, y: 270.68359375, angle: -43, scale: 1, flip: 1, coordinateSpace: 'section', phone: { left: 32.76, top: 1473.8, width: 117, x: 32, y: 123, angle: -70, scale: 0.73, flip: 1 }, deleted: true },
    'corner-branch': { left: 0, top: 0, width: 320, x: -0.328125, y: 0, angle: 0, scale: 1, flip: 1, deleted: true },
    'added-plant-opening-babys-breath-right-mrobnbvu-2': { added: true, catalogId: 'plant-opening-babys-breath-right', sectionId: 'numbers', left: 1120, top: 577.17578125, width: 168, x: 360.55859375, y: -105.2734375, angle: 45, scale: 0.8, flip: -1, coordinateSpace: 'viewport', phone: { deleted: true }, deleted: true },
    ...
    'added-plant-opening-babys-breath-right-mrobtsww-1': { added: true, catalogId: 'plant-opening-babys-breath-right', sectionId: 'montage', left: 1120, top: 664.46875, width: 168, x: 249.1328125, y: 284.515625, angle: 50, scale: 0.88, flip: -1, coordinateSpace: 'section', phone: { deleted: true }, deleted: true },
    ...
    'added-plant-dried-flower-daisy-mrobv8ko-3': { added: true, catalogId: 'plant-dried-flower-daisy', sectionId: 'montage', left: 1120, top: 2190.1484375, width: 185, x: -525.83984375, y: 136.82421875, angle: -28, scale: 0.75, flip: -1, coordinateSpace: 'section', phone: { deleted: true }, deleted: true },
    'added-plant-dried-cosmos-stem-mror1ph1-1': { added: true, catalogId: 'plant-dried-cosmos-stem', sectionId: 'beginning', left: 683, top: 830.640625, width: 137, x: -462.6015625, y: -238.90625, angle: -22, scale: 1, flip: -1, coordinateSpace: 'section', phone: { deleted: true }, deleted: true },
    'added-plant-dried-flower-wildflower-bundle-mror227e-2': { added: true, catalogId: 'plant-dried-flower-wildflower-bundle', sectionId: 'beginning', left: 683, top: 830.640625, width: 191, x: 454.4609375, y: 281.5, angle: 38, scale: 0.74, flip: -1, coordinateSpace: 'section', phone: { deleted: true }, deleted: true },
    'added-plant-dried-cosmos-stem-mror70sz-5': { added: true, catalogId: 'plant-dried-cosmos-stem', sectionId: 'montage', left: 683, top: 2311.484375, width: 137, x: 927.640625, y: 4.3203125, angle: 65, scale: 0.86, flip: -1, coordinateSpace: 'section', phone: { deleted: true }, deleted: true },
    ...
    'added-plant-dried-cosmos-stem-mrumsjqm-1': { added: true, catalogId: 'plant-dried-cosmos-stem', sectionId: 'beginning', left: 1120, top: 579, width: 145, x: -447.94140625, y: 24.984375, angle: -46, scale: 1, flip: 1, coordinateSpace: 'section', deleted: true },
  };
